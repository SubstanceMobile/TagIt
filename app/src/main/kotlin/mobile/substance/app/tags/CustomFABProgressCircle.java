 ...
 */
public class CustomFABProgressCircle extends FrameLayout implements ArcListener, CompleteFABListener {
    ...
    public CustomFABProgressCircle(Context context) {
        super(context);
        init(null);
    }

    public CustomFABProgressCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public CustomFABProgressCircle(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CustomFABProgressCircle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public ProgressArcView getProgressArcView() {
        return progressArc;
    }
